...
-- @Project: FiveM Tools
-- @Last modified time: 2017-06-11T10:25:42+02:00
...
Ui.DrawMenuButton = function(data, x, y, width, height, selected)
  Citizen.CreateThread(function()
    ...
    if data.subText ~= nil then
      if selected then
        Ui.DrawText(data.subText, 0, 0, x + width / 2 - 0.0385, y - height / 2 + 0.0028, 0.4, 0, 0, 0, 255)
      else
        Ui.DrawText(data.subText, 0, 0, x + width / 2 - 0.0385, y - height / 2 + 0.0028, 0.4, 255, 255, 255, 255)
      end
    end
